...
-- Fix the generate_training_cycles trigger to use plan's cycle_duration_days
...
BEGIN
  ...
  -- Get cycle_duration_days and duration_days from the plan (priority over enrollment)
