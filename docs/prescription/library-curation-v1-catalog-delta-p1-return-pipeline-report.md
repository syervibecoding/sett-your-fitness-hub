...
## Entradas
- Label: `library-curation-v1-catalog-delta-p1`
- Prioridade: `P1`
- Manifesto: `docs/prescription/library-curation-v1-catalog-delta-human-review.csv`
- Enviado (sent): `docs/prescription/library-curation-v1-catalog-delta-p1-human-review.csv`
- Devolvido (returned): `docs/prescription/library-curation-v1-catalog-delta-p1-human-review.csv`
- Out-dir: `docs/prescription`
- keep-going: `false`
- Timestamp: `2026-06-19T09:13:00.450Z`
...
- `docs/prescription/library-curation-v1-catalog-delta-p1-return-guard-report.md`
- `docs/prescription/library-curation-v1-catalog-delta-p1-human-review-validation-report.md`
